...
export default function ViewJob() {
  ...
  return (
    <>
      <h2 className="mb-4 pl-5 text-xl font-semibold">View Jobs</h2>
      <div className="mx-auto rounded-lg bg-white shadow-lg md:p-6">
        ...
        <div className="justify-end px-5 pt-8 md:flex">
          <div className="pb-4">
            <button className="mr-5 w-full rounded border px-4 py-2 text-[12px] font-semibold md:w-[170px] md:px-5 md:py-1 md:text-lg">
              Delete Selected
            </button>
          </div>
          <div>
