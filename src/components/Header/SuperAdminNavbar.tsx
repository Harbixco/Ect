    ...
    <div className="flex w-full items-center justify-between text-white">
      <div className="relative w-full">
        ...
        <div className="relative w-full ">
          ...
          <input
            type="text"
            className="block w-full rounded-lg border border-black px-2.5 py-[6px] ps-10 text-base text-black shadow-none outline-none focus:border-black focus:ring-0 md:w-[85%] lg:w-[70%]"
      ...
      <div className="hidden w-full items-center justify-end gap-x-16 md:flex ">
        ...
        <div className="flex items-center gap-x-3">
          <div className="size-12 rounded-full ">
            <img src={admin} alt="profile" className="w-full rounded-full" />
          </div>
          <div className="">
